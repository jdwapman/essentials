...
num_row_tiles = ceil(analyze_mat.shape[0] / tile_size)
num_col_tiles = ceil(analyze_mat.shape[1] / tile_size)
...
for col_tile_idx in range(0, num_col_tiles):
    ...
    for row_tile_idx in range(0, num_row_tiles, num_SMs):
        ...
        for sm_idx in range(0, num_SMs):
            ...
            row_end = min(row_start + tile_size, analyze_mat.shape[0])
            col_start = col_tile_idx * tile_size
            col_end = min(col_start + tile_size, analyze_mat.shape[1])
